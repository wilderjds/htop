...
int CRT_colorSchemes[LAST_COLORSCHEME][LAST_COLORELEMENT] = {
   [COLORSCHEME_DEFAULT] = {
      ...
      [METER_TEXT] = ColorPair(White,Black),
      [METER_VALUE] = A_BOLD | ColorPair(Cyan,Black),
      [LED_COLOR] = ColorPair(Green,Black),
      [TASKS_RUNNING] = A_BOLD | ColorPair(Green,Black),
      [PROCESS] = A_NORMAL,
      [PROCESS_SHADOW] = ColorPair(Yellow,Black),
      ...
      [PROCESS_HIGH_PRIORITY] = ColorPair(Magenta,Black),
      ...
      [LOAD_AVERAGE_ONE] =  ColorPair(White,Black),
      [LOAD] = A_BOLD,
